...
urlpatterns = [
    ...
    path("our-services", all_service, name="all-services"),
    path("our-services/bbbee-consulting-and-training", bbbee_consulting_and_training, name="bbbee-consulting-and-training"),
    path("our-services/talent-management-and-development", talent_management_and_development, name="talent-management-and-development"),
    path("our-services/governance-and-direction", governance_and_direction, name="governance-and-direction"),
    path("our-services/systems-reviews-and-assurance", systems_reviews_and_assurance, name="systems-reviews-and-assurance"),
